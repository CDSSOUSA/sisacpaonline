            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        echo form_open('atendimento/justificar_falta_usuario', $atributos_formulario);
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <div class="demo-checkbox">  
                                                    <input type="checkbox" id="iRepeteTodas" class="checkbox-inline" name="nRepeteTodas" value="S"
                                                    <?php echo set_checkbox('nRepeteTodas', 'S', FALSE); ?> /> <label
                                                    for="iRepeteTodas"> Todas as faltas? </label><br>                                           
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-offset-3 col-md-offset-3 col-sm-offset-4 col-xs-offset-5">
                                ...
                                echo gerarbotaoVoltar('atendimento/listar_faltas_usuario/'.encrypt($idUsuario));
                                ?>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
