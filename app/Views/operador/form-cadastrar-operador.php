...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group row">
            <label for="<?= $atributos['cpfOperador']['id'] ?>" class="col-sm-3 col-form-label font-weight-bold">
                <?= $atributos['cpfOperador']['label'] ?>
            </label>
            <div class="col-sm-8">
                <input id="<?= $atributos['cpfOperador']['id'] ?>" type="text"
                    name="<?= $atributos['cpfOperador']['name'] ?>" class="form-control"
                    placeholder="<?= $atributos['cpfOperador']['label'] ?>"
                    onclick="clearMessageError('<?= $atributos['cpfOperador']['iError'] ?>')">

                <p style="" class="text-danger mb-1" id="<?= $atributos['cpfOperador']['iError'] ?>">
                </p>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <select id="<?= $atributos['tipoOperador']['id'] ?>" class="custom-select"
                ...
                <p style="" class="text-danger mb-1" id="<?= $atributos['tipoOperador']['iError'] ?>">
                </p>
            </div>
        </div>
